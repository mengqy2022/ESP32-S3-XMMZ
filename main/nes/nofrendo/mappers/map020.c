...
{
    MESSAGE_INFO("FDS write at %04lX: %02X\n", (unsigned long)address, (unsigned)value);
...
{
    MESSAGE_INFO("FDS sound read at %04lX\n", (unsigned long)address);
    return 0x00;
}

static void fds_sound_write(uint32 address, uint8 value)
{
    MESSAGE_INFO("FDS sound write at %04lX: %02X\n", (unsigned long)address, (unsigned)value);
}

static uint8 fds_wave_read(uint32 address)
{
    MESSAGE_INFO("FDS wave read at %04lX\n", (unsigned long)address);
    return 0x00;
}

static void fds_wave_write(uint32 address, uint8 value)
{
    MESSAGE_INFO("FDS wave write at %04lX: %02X\n", (unsigned long)address, (unsigned)value);
}
